...
date: '2019-10-20'
slug: command-line-input-output
categories:
  - bash
tags:
  - bash
...
This is the fourth tutorial in the series [Command Line Basics for R Users](https://tutorials.rsquaredacademy.com/command-line/index.html). In this tutorial, we will learn about input & output.

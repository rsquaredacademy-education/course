...
This is the fifth tutorial in the series [Elegant Data Visualization with 
ggplot2](https://tutorials.rsquaredacademy.com/data-visualization/index.html). In the previous tutorial, we learnt about text annotations. In this 
tutorial, we will: 
...
As we did in the previous tutorial, let us begin by creating a scatter plot using  
...
In the next tutorial, we will learn to build line charts.

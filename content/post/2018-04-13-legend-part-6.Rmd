...
This is the 18th tutorial in the series [Elegant Data Visualization with ggplot2](https://tutorials.rsquaredacademy.com/data-visualization/index.html). 
In the previous tutorial, we learnt how to modify the legend of plot when `alpha` 
is mapped to a categorical variable. In this tutorial, we will learn to modify legend
...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/a77a836e7e06c61c28ba7db3a69e1510).
...
In this tutorial, we will learn to modify legend
...
In the next tutorial, we will learn faceting.

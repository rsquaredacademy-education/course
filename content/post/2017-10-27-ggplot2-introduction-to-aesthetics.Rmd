...
This is the fourth tutorial in the series [Elegant Data Visualization with 
ggplot2](https://tutorials.rsquaredacademy.com/data-visualization/index.html). In the previous tutorial, we learnt about geoms and how we can use them 
...
for the different geoms we learnt in the previous tutorial. 
...
the previous tutorial, we used `geom_line()` to build line charts. Now we will 
...
In this tutorial, we learnt about aesthetics i.e. how to modify the properties of 
geoms such as:
...
In the next tutorial, we will learn to modify the axis and labels of a plot. 

...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/f44774d9c6e115c08d5e2e693380a00f).
...
In the next tutorial, we will learn advanced SQL commands.

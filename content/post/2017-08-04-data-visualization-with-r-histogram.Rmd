...
This is the seventh tutorial in the series [Data Visualization With R](https://tutorials.rsquaredacademy.com/data-visualization/index.html). In the previous tutorial, we learnt about box and whisker plots. In this tutorial, we will learn to:
...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/7dbcd02b37e80c5262133d0464b7e8c9).
...
Before we end this tutorial, let us add a title and axis labels to the histogram. 
...
In this tutorial, we learnt how to construct and use histograms to examine the underlying distribution of a continuous variable. Specifically, we learnt how to:

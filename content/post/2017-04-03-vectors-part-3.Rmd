...
In this tutorial, we will learn to index/subset vectors.

## Index Vectors

One of the most important steps in data analysis is selecting a subset of data from a bigger data set. Indexing helps in retrieving values individually or a set of values that meet a specific criteria. In this tutorial, we look at various ways of indexing/subsetting vectors.

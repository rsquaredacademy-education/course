...
This is the last tutorial in the series [Elegant Data Visualization with ggplot2](https://tutorials.rsquaredacademy.com/data-visualization/index.html). 
In the previous tutorial, we learnt to combine multiple plots. In this tutorial, we 
...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/a6722c54610578ddcadaeeaf1df7cbf3).
...
In this tutorial, we learnt to modify the appearance of all non data components 

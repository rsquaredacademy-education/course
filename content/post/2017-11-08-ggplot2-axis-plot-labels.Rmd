...
ggplot2](https://tutorials.rsquaredacademy.com/data-visualization/index.html). In the previous tutorial, we learnt about aesthetics. In this tutorial, we 
will learn to:
...
In the next tutorial, we will learn to add text annotations to plots.
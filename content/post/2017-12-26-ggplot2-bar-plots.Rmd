...
This is the ninth tutorial in the series [Elegant Data Visualization with 
ggplot2](https://tutorials.rsquaredacademy.com/data-visualization/index.html). In the previous tutorial, we learnt to build line charts. In this tutorial, 
we will learn to:
...
background color of the bars. We will look at that later in the tutorial.
...
In the next tutorial, we will learn to build box plots.

...
This is the third tutorial in the series **Data Visualization With R**. In the previous tutorial, we learned how to add title, subtitle and axis labels. We also learned how to modify the range of the axis. In this tutorial, we will learn how to create scatter plots. 

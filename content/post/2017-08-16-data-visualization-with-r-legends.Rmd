...
This is the eighth tutorial in the series [Data Visualisation With R](https://tutorials.rsquaredacademy.com/data-visualization/index.html). In the previous tutorial, we learnt to build histograms. In this tutorial, we will learn how to:
...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/0036a9cc1ca779965f45c38af260dcdc).
...
In this tutorial, we learnt to add legend to a plot using the `legend()` function. Specifically, we learnt to

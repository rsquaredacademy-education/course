...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/f5ee72cee9ab3256230cdedecd3ef25b).
...
In the next [tutorial](), we will learn basic SQL commands.

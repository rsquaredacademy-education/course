...
This is the sixth tutorial in the series **Data Visualization With R**. In the previous tutorial, we learnt how to build bar plots. In this tutorial, we will learn to

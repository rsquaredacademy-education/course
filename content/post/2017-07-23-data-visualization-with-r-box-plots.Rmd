...
This is the sixth tutorial in the series [Data Visualization With R](https://tutorials.rsquaredacademy.com/data-visualization/index.html). In the previous tutorial, we learnt how to build bar plots. In this tutorial, we will learn to
...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/d5e49b7903a54bd02d77ae2057f05d4a).
...
We will end this tutorial by adding a title and axis labels to the box plot. 
...
In this tutorial, we learnt how to create box plots. Specifically, we learnt to:

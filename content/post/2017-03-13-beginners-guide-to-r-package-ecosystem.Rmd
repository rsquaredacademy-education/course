...
In this tutorial, we will learn about R packages. Packages are fundamental to R. There are approximately 15000 packages available on [CRAN](https://cran.r-project.org/) or the Comprehensive R Archive Network.

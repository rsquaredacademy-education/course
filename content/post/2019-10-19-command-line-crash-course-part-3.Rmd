...
date: '2019-10-19'
slug: command-line-file-management
categories:
  - bash
tags:
  - bash
...
This is the third tutorial in the series [Command Line Basics for R Users](https://tutorials.rsquaredacademy.com/command-line/index.html). In this tutorial, we will learn about file management.

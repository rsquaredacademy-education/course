...
This is the fourth tutorial in the series **Data Visualization With R**. In the previous tutorial, we learnt how to build scatter plots. In this tutorial, we will build line graphs. To be more specific we will learn to 

...
This is the fourth tutorial in the series [Data Visualization With R](https://tutorials.rsquaredacademy.com/data-visualization/index.html). In the previous tutorial, we learnt how to build scatter plots. In this tutorial, we will build line graphs. To be more specific we will learn to 
...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/ea80f20e798e25b3adfc9ff1e87ed311).

### Line Graph

To build a line graph, we will learn a new argument in the `plot()` function called `type`. It allows us to specify the symbol that must be used to represent the data. Let us begin by building a simple line graph. We will use the `AirPassengers` data set in this tutorial. Before we begin to build the plot, let us take a quick look at the data in order to understand what we are plotting.
...
We can enhance the points in the line plot in the same way as we enhanced the points in the scatter plot in this previous tutorial. Let us look at an example:
...
Finally let us enhance the plot by adding a title and modifying the axis labels which we learnt in this first tutorial of the series.

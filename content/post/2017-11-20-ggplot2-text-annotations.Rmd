...
This is the sixth tutorial in the series [Elegant Data Visualization with 
ggplot2](https://tutorials.rsquaredacademy.com/data-visualization/index.html). In the previous tutorial, we learnt to modify the axis and plot labels. 
In this tutorial, we will learn to add text to the plots.
...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/567094325b5e134b5b4459677206f363).
...
In the next tutorial, we will learn to build scatter plots.

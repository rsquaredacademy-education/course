...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/7a445b32ca3a6e1f75e7d4bbf66cb702).
...
In this tutorial, we learnt how to add text annotations to a plot. Specifically, we learnt to:
...
In the next tutorial, we will learn how to combine multiple plots into a single frame. 

...
This is the first tutorial of the series [Data Visualization With R](https://tutorials.rsquaredacademy.com/data-visualization/index.html). The objective of the series is to provide a gentle introduction to working with base graphics in R. We will come up with a similar series using [ggplot2](https://ggplot2.tidyverse.org/index.html) shortly. 
...
All the data sets used in this tutorial can be found [here](https://github.com/rsquaredacademy/datasets) and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/3690e9217c72644a9e9bada0df709426).
...
In this first tutorial, we have explored the `plot()` function to understand the different types of plots it can create based on the input types. Before we begin to build different plots such as bar plots, box plots, scatter plots or line plots, we will quickly learn how to add title and labels to a plot. 
